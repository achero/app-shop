    ...
    <div class="container">
                ...
                <div class="row">
                    ...
                    <div class="col-md-4">
                        <div class="info">
                            ...
                            <p>Todo pedido que realices será confirmado a través de una llamada. si no confias en los pagos en linéa puedes pagar contra entrega el valor acordado.</p>
                        </div>
                    </div>
                    <div class="col-md-4">
                        <div class="info">
                            ...
                            <p>Los pedidos que realices sólo lo conecerás tú a través de tu panel de usuario. Nadie más tiene acceso a esta información.</p>
                        </div>
                    </div>
                </div>
            </div>
        ...
        <div class="section text-center">
            ...
            <form class="form-inline" method="get" action=" {{ url('/search') }} ">
                <input type="text" placeholder="¿Qué producto buscas?" name="query" id="search" class="form-control">
                ...
                <div class="row">
                    ...
                    <div class="col-md-4">
                        <div class="team-player">
                            <img src="{{ $category->featured_image_url }}" alt="Imágen representativa de la categoría {{ $category->name }}" class="img-raised img-circle">
                            <h4 class="title">
                ...
                <div class="col-md-8 col-md-offset-2">
                    ...
                    <form class="contact-form">
                        <div class="row">
                            ...
                            <div class="col-md-6">
                                <div class="form-group label-floating">
                                    <label class="control-label">Correo eléctrónico</label>
                                    <input type="email" class="form-control">
                                </div>
                            </div>
                        </div>
...
@section('scripts')
    ...
    <script>
        $(function (){
            ...
            //inicializar typeahead sobre nuesto input de búsqueda
            $("#search").typeahead({
                hint: true,
                highlight: true,
                minLength: 1
